...
```{r}
arr_delay_df2 <- icu_patients_df1[, c("in_hospital_death", "Albumin_min", "Bilirubin_max", "Creatinine_max", "HCO3_diff", "SAPS1", "BUN_min", "GCS_max", "pH_min", "Glucose_max", "SaO2_max", "Height", "Weight_diff")]
