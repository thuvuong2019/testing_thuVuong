...
* The 'Creatinine' variables (min, diff, max) are positively correlated with corresponding 'BUN' Blood Urea Nitrogen variables.
...
_Most ICU admissions are negatively correlated with other ICU admissions. This is intuitive as it is rare to require multiple different ICU admissions except in complex patients. Cardiac Surgery Recovery ICU and Surgical ICU are the most negatively correlated at -0.46._
